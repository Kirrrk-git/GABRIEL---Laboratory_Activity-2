...
A Python OOP program demonstrating classes, methods, user input, and exception handling.
Author: Gabriel
Laboratory Activity 2 - CS15
"""
...
def get_valid_amount(prompt):
    """
    Get a valid monetary amount from the user with error handling.
